...
install_emerge() {
    run_privileged emerge --noreplace \
        net-libs/nodejs dev-lang/python app-arch/7zip app-arch/dpkg \
        app-arch/unzip app-crypt/gnupg net-misc/curl sys-devel/gcc \
        dev-build/make sys-apps/portage app-arch/tar
}
