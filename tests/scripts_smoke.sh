...
bash -n scripts/lib/*.sh scripts/build-deb.sh scripts/build-rpm.sh scripts/build-pacman.sh scripts/build-gentoo.sh scripts/install-gentoo.sh scripts/build-appimage.sh scripts/user-service.sh
...
assert_contains Makefile 'make gentoo'
assert_contains Makefile 'scripts/install-gentoo.sh'
assert_contains scripts/lib/package-common.sh 'openrc-user'
