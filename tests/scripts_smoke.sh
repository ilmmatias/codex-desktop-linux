...
bash -n scripts/lib/*.sh scripts/build-deb.sh scripts/build-rpm.sh \
  scripts/build-pacman.sh scripts/build-gentoo.sh scripts/install-gentoo.sh \
  scripts/build-appimage.sh scripts/user-service.sh
